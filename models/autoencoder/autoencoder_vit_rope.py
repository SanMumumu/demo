...
class ViTAutoencoder(nn.Module):
    def __init__(self,
        ...
        # --- REPLACED: Removed Additive Positional Embeddings ---
        # self.xy_pos_embedding = ...
        # self.xt_pos_embedding = ...
        # self.yt_pos_embedding = ...
        ...
        self.pre_xy = torch.nn.Conv2d(dim, self.embed_dim, 1)
        self.pre_xt = torch.nn.Conv2d(dim, self.embed_dim, 1)
        self.pre_yt = torch.nn.Conv2d(dim, self.embed_dim, 1)
