...
CUDA_VISIBLE_DEVICES=0,1,2,3 python3 main.py --config configs/run/train/sync_city.yaml --num_workers 8 --output=./debug1

CUDA_VISIBLE_DEVICES=2,3,4,5 python3 main.py --config configs/run/train/ae_city_rgb.yaml --output=./debug1

CUDA_VISIBLE_DEVICES=4,5,6,7 python3 main.py --config configs/run/train/sync_city.yaml --output=./debug1
